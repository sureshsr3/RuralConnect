...
def extract_information(text):
    ...
    return   booking_date, entities

def extract_net_amount_due(text):
...
net_amount_due=extract_net_amount_due(text)
booking_date, entities = extract_information(extracted_text)
text=ocr(image_path)
